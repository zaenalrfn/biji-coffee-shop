...
import '../../data/models/chat_order_model.dart'; // Import ChatOrder
...
class _MessageListPageState extends State<MessageListPage> {
  ...
  List<ChatOrder> _chats = []; // Update type
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _buildMessageTile(
                            ...
                            time: chat.time,
                            avatar: chat.avatar ?? 'assets/images/profile1.jpg',
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.message_outlined, size: 60, color: Colors.grey.shade300),
